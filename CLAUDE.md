...
- apply_hblink_config_text(string $config_text, int $actor_id, ?int $rolled_back_from_id) → app/config/generator.php (F16, planned)
- import_subscribers_from_radioid(bool $force) → app/subscribers/manager.php (F14, planned)
<!-- SPECKIT END -->
